...
association_table = (
    "emprestimos",
    Base.metadata,
    Column("funcionario_id", ForeignKey("funcionario.id"), primary_key=True),
    Column("uniforme_id", ForeignKey("uniforme.id"), primary_key=True),
...
class Funcionario(Base):
    ...
    uniformes: Mapped[List[Uniforme]] = relationship(secondary=association_table,
...
class Uniforme(Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True, autoincrement=True)
    nome: Mapped[str] = mapped_column(nullable=False)
    funcionario: Mapped[List[Funcionario]] = relationship(secondary=association_table,
                                                          back_populates='uniformes',
                                                          lazy=False)
